    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
     ...
     <body>
       ...
       <a class="navbar-brand">Dashboard - Buchungssystem für die Online-Lehre an der HS Bremerhaven  |  User : <?php echo $_SESSION["user"];?></a>
        ...
        <div class="card-body">
         <p class="card-text">Schauen Sie sich hier ganz einfach den Status der Anträge an. Außerdem können Sie die Anträge hier bearbeiten.</p>
         <form class="form-inline" action ="https://informatik.hs-bremerhaven.de/swe2_2020team09/mitarbeitende/antragsübersicht.php">
